...
'8967522162:AAFlGP9vkDd-51RytlNdDlI3qyie-1-RBH4'

'8770697465:AAGÂGJUqAfEDw9Okd0M8Epm5Sts1ihTsSIs'

'8779581819:AAFOtKPUZ1jZV_t_0BflGa30k8q8fAhClz4'

'8783433733:AAFÂhvVZu8Tk75FqdFex5E1Dzlo7uewWafk'
]

OWNER_ID = 7153197678
ADMIN_IDS = {8690979090}
...
GROUP_TITLES = [
    "𝑯𝑶𝑻𝑻𝑹𝑬𝑶 HQUYWMINHTHINH 𝙗á 𝙨à𝙣 𝙩𝙧𝙚𝙤❄️☄️🌠☃️",
    " 𝑯𝑶𝑻𝑻𝑹𝑬𝑶 HQUYWMINHTHINH 𝙙𝙞ệ𝙩 𝙡ũ 𝙥𝙝ế 💔🌠💤",
    "☄🚀 𝑯𝑶𝑻𝑻𝑹𝑬𝑶 HQUYWMINHTHINH 𝙘â𝙣 𝙖𝙡𝙡 𝙗ọ𝙣 𝙠𝙞𝙙𝙨🌌✈💤",
    "☄️ 𝑯𝑶𝑻𝑻𝑹𝑬𝑶 HQUYWMINHTHINH  𝙝ủ𝙮 𝙙𝙞ệ𝙩 𝙡ũ 𝙣𝙜𝙪🚀🌠☃️",
    "☄️ 𝑯𝑶𝑻𝑻𝑹𝑬𝑶 HQUYWMINHTHINH 𝙝ủ𝙮 𝙙𝙞ệ𝙩 𝙗á 𝙨à𝙣 𝙖𝙡𝙡 𝙩𝙚𝙡𝙚𝙜𝙧𝙖𝙢🚀✈💤",
    "☄️🚀 𝑯𝑶𝑻𝑻𝑹𝑬𝑶 HQUYWMINHTHINH 𝙗ọ𝙣 𝙗ố 𝙗á đ𝙖 𝙖𝙥𝙥?𝙚✈🌠🌸💤",
    "☄️🚀 𝑯𝑶𝑻𝑻𝑹𝑬𝑶 HQUYWMINHTHINH 𝙗ọ𝙣 𝙘𝙝𝙖 𝙩𝙝ố𝙣𝙜 𝙩𝙧ị 🌌🐲💤",
    "☄️🚀 𝑯𝑶𝑻𝑻𝑹𝑬𝑶 HQUYWMINHTHINH 𝙗ọ𝙣 𝙗ố 𝙗á 𝙨à𝙣 𝙩𝙚𝙡𝙚𝙜𝙧𝙖𝙢☃️🌌🥀💤",
    "☄️🚀 𝑯𝑶𝑻𝑻𝑹𝑬𝑶 HQUYWMINHTHINH 𝙝ủ𝙮 𝙙𝙞ệ𝙩 𝙡ũ 𝙣𝙜𝙪💫🐉💤",
]
...
async def doi_ten(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await context.bot.send_message(cid, "𖣘𓂄𓆩𝘼𝙀 𝙉𝙏𝘽𝘼𓆪𓂁𖣘")
    ...
    try:
        while tid in stop_events and not stop_events[tid].is_set():
            try:
                ...
                if mode == "sp4":
                    tin_nhan_co_dinh = """✭亗✭HAI*QUY*MTHINH*𝙎𝙥𝙖𝙢*𝙈𝙚𝙨𝙨𝙖𝙜𝙚*𝙋𝙧𝙞𝙢𝙞𝙪𝙢ϟ✿👹✿🛸　　　✿🌎　°　✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿�
�✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿▁▂▃▄▅▆▇▇▆▅▅▆▇▇▆▅▄▃▂▁☆"""
                    tin_nhan_da_escape = html.escape(tin_nhan_co_dinh)
                ...
                if text:
                    ...
                    if token not in sent_messages_dict: 
                        sent_messages_dict[token] = []
...
async def handle_war_all(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not hasattr(context.application, 'attack_tasks'):
        context.application.bot_data["attack_tasks"] = []
...
async def handle_war(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    m_mode = {"/sp1":"sp1", "/sp2":"sp2", "/sp3":"sp3", "/sp4":"sp4"}.get(cmd, "sp")
    task = asyncio.create_task(attack_engine(context.application.bot, cid, uids, tid, m_mode, txt, tok))
    if not hasattr(context.application, 'attack_tasks'):
        context.application.bot_data["attack_tasks"] = []
    context.application.bot_data.setdefault("attack_tasks", []).append(task)
...
async def handle_admin(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if uid:
        ...
        if context.application.bot.token == BOT_TOKENS[0]:
            msg = f"<a href='tg://user?id={uid}'>𖣘𓂄𓆩𝘼𝙀 𝙉𝙏𝘽𝘼𓆪𓂁𖣘</a>"
            await context.application.bot.send_message(
                chat_id=update.effective_chat.id,
                text=msg,
                parse_mode=ParseMode.HTML
...
async def add_admin(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    response_message = f"<b>𖣘𓂄𓆩𝘼𝙀 𝙉𝙏𝘽𝘼𓆪𓂁𖣘 𝐔𝐩𝐝𝐚𝐭𝐞:</b>\n\nĐã Thêm Admin: <code>{target_admin_id}</code>"
...
async def handle_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text=(
        ...
        "║   🌈💎 SIÊU VIP PRO MAX  💎🌈   ║\n"
        "╚════════════════════════════════════╝\n"
        "<i>✨ Gõ lệnh hoặc reply tin nhắn để sử dụng ✨</i>\n"
        "<b>🌟━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━🌟</b>"
    )
...
async def boot(token, pool):
    try:
        ...
        app.add_handler(CommandHandler(["sp", "sp1", "sp2", "sp3", "sp4"], handle_war))
        ...
        print(f"{colors[len(pool) % len(colors)]}⚡ {token[:8]}... | {rainbow} | 𖣘𓂄𓆩𝑯𝑶𝑻𝑻𝑹𝑬𝑶 𝑫𝒐𝑲𝒉𝒂𝒏𝒈𓆪𓂁𖣘 | Bot {len(pool)}/13 Online{reset}")
        return app
    except Exception as e:
        print(f"💥 {token[:8]}... | 𖣘𓂄𓆩𝘼𝙀 𝙉𝙏𝘽𝘼𓂁𖣘 | Lỗi: {str(e)[:30]}")
        return None
...
async def main():
    ...
    banner_hien_thi += "\033[92m║      \033[93m🌈 \033[94m𖣘𓂄𓆩𝘼𝙀 𝙉𝙏𝘽𝘼𓆪𓂁𖣘 \033[95m🌈      ║\n"
    ...
    try:
        ...
        chuoi_thong_bao_thanh_cong += "   \033[93m𖣘𓂄𓆩𝘼𝙀 𝙉𝙏𝘽𝘼𓆪𓂁𖣘 \033[94msẵn sàng chiến đấu! \033[91m🔥\033[0m\n"
        ...
        print("   \033[96m𖣘𓂄𓆩𝘼𝙀 𝙉𝙏𝘽𝘼𓆪𓂁𖣘 \033[95mtạm biệt! \033[91m👋\033[0m")
